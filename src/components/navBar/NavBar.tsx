...
export const NavBar = () => {
    return (
        <div className="justify-center items-center h-52 bg-gradient-to-r from-[#574AE8] to-[#3EA1DB] text-white mb-24">
            <nav className="container mx-auto max-w-lg md:max-w-7xl pt-12 px-5 items-center">
                ...
                <div className=" flex flex-row bg-[#3EA1DB] items-center gap-2 max-w-full p-3 rounded-md">
                   <Lupa/>
